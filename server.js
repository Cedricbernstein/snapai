  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: `You are a product photography prompt engineer. Analyze reference images and product image. Output ONLY this JSON:
...
app.post("/api/generate-image", async (req, res) => {
  ...
  try {
    ...
    console.log("OpenAI status:", openaiRes.status, JSON.stringify(openaiData).substring(0, 200));
